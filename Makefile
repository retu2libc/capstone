...
DEP_TMS320C67X =
DEP_TMS320C67X += $(wildcard arch/TMS320C67x/TMS320C67x*.inc)
...
LIBOBJ_TMS320C67X =
ifneq (,$(findstring tms320c67x,$(CAPSTONE_ARCHS)))
	CFLAGS += -DCAPSTONE_HAS_TMS320C67X
	LIBSRC_TMS320C67X += $(wildcard arch/TMS320C67x/TMS320C67x*.c)
	LIBOBJ_TMS320C67X += $(LIBSRC_TMS320C67X:%.c=$(OBJDIR)/%.o)
endif
...
LIBOBJ += $(LIBOBJ_X86) $(LIBOBJ_XCORE) $(LIBOBJ_TMS320C64X) $(LIBOBJ_TMS320C67X) $(LIBOBJ_M680X) $(LIBOBJ_EVM) $(LIBOBJ_MOS65XX) $(LIBOBJ_WASM) $(LIBOBJ_BPF)
...
$(LIBOBJ_TMS320C67X): $(DEP_TMS320C67X)
